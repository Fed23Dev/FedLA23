...
class ResNet(nn.Module):
    def __init__(self, block, num_layers, compress_rate, num_classes=10, input_channel=3):
        ...
        self.layer_num = 0
        self.conv1 = nn.Conv2d(input_channel, self.overall_channel[self.layer_num], kernel_size=3, stride=1, padding=1,
                               bias=False)
